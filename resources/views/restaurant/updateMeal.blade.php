        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{__('Update Meal')}}</li>
            </ol>
          </nav>
            ...
            <div class="ms-panel-body">
              ...
              @csrf
                <div class="form-row">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="mealName_ar" value="{{ $meal->mealName_ar }}"  class="form-control @error('mealName_ar') is-invalid @enderror" id="validationCustom18" placeholder="Meal Name" required >
                      <div class="valid-feedback">
                        {{{__('Looks good')}}}!
                      </div>
                      @error('mealName_ar')
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <select class="form-control @error('screen') is-invalid @enderror " name="screen" id="screenidlabelinput" >
                        ...
                        @if ($meal->screen_id != null )

                        @foreach ($all_Screens as $screen)
                    
                        @if ($screen->id ==  $meal->screen->id  )
                                   
                        <option value="{{ $screen->id }}" selected="selected" >{{ $screen->name_screen }}  </option>
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">{{__('Image')}}</label>
                ...
                <div class="ms-panel-header new">
                  <button  class="btn btn-primary d-block" type="submit">Update Meal</button>
                </div>
      ...
      <button  onclick="addLine()" data-toggle="tooltip" data-placement="left" title="Add a Task to this block" class="ms-btn-icon float-right"> <i class="material-icons text-disabled">add</i> </button>
             ...
             @foreach ($ingredients as $ingredient)
                  ...
                  <li class="ms-list-item ms-to-do-task ms-deletable">
                   ...
                   <div class="col-md-12 mb-3">
                    <label for="validationCustom25">{{__('qnt')}}</label>
                    <div class="input-group">

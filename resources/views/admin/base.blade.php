...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <!-- Restaurant -->
      <li class="menu-item">
        <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#advanced-elements" aria-expanded="false" aria-controls="advanced-elements"> <span><i class="material-icons fs-16">restaurant</i>Restaurant</span>
        </a>
...
@foreach($privileges as $privilege)
      ...
      <!-- product -->
      <li class="menu-item">
        <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#product" aria-expanded="false" aria-controls="product"> <span><i class="material-icons fs-16">menu_book</i>Menus </span>
        </a>
      ...
      @if ($privilege->privilegeName == "stocks")
           <!-- stock product -->
           <li class="menu-item">
        <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#product1" aria-expanded="false" aria-controls="product1"> <span><i class="material-icons fs-16">category</i>Stock Products </span>
        </a>
...
<!-- Provider-->
<li class="menu-item">
  <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#customershh" aria-expanded="false" aria-controls="customershh"> <span><i class="material-icons fs-16">people_alt</i>Customers </span>
  </a>
...
@endforeach
    ...
    <!-- Provider-->
    <li class="menu-item">
      <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#allotherthing" aria-expanded="false" aria-controls="allotherthing"> <span><i class="material-icons fs-16">create_new_folder</i>Others </span>
      </a>
      <ul id="allotherthing" class="collapse" aria-labelledby="allotherthing" data-parent="#side-nav-accordion">
      
        <li> <a href="{{ url('admin/others') }}">Others</a>
        </li>

        <li> <a href="{{ url('admin/promoCode') }}">Promo Code</a>
        </li>

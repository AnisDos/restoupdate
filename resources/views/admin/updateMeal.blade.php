            ...
            <div class="ms-panel-body">
              ...
              @csrf
                <div class="form-row">
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Meal Name In Arabic </label>
                    <div class="input-group">
                   
                      <input type="text" name="mealName_ar" value="{{ $meal->mealName_ar }}"  class="form-control @error('mealName_ar') is-invalid @enderror" id="validationCustom18"  >
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                      @error('mealName_ar')

...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
         ...
         <!-- Basic UI Elements -->
         <li class="menu-item">
          <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#basic-elements" aria-expanded="false" aria-controls="basic-elements"> <span><i class="material-icons fs-16">admin_panel_settings</i>Manage</span>
          </a>
     ...
     <!-- charge -->
     <li class="menu-item">
      <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#invoice" aria-expanded="false" aria-controls="invoice"> <span><i class="material-icons fs-16">bar_chart</i>Charge </span>
      </a>
...
var _token = $('input[name="_token"]').val();
    ...
    $.ajax({
    url:"{{ url('superadmin/sendNewTodo') }}",
    method:"POST",

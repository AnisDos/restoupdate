...
@if ($privilege->privilegeName == "stocks")
        <!-- stock product -->
        <li class="menu-item">
            <a href="#" class="has-chevron clikihafhome" data-toggle="collapse" data-target="#product1{{$privilege->privilegeName}}" aria-expanded="false" aria-controls="product1{{$privilege->privilegeName}}"> <span><i class="fa fa-archive fs-16"></i>{{$privilege->privilegeName}}  </span>
            </a>
            <ul id="product1{{$privilege->privilegeName}}" class="collapse" aria-labelledby="product1{{$privilege->privilegeName}}" data-parent="#side-nav-accordion">
              ...
              <li> <a href="{{ url('employee/stocks/allProducts') }}">All Products</a>
              </li>
              <li> <a href="{{ url('employee/stocks/addNewProduct') }}">Add New Product</a>
              </li>
           
              <li> <a href="{{ url('employee/stocks/versionProduct') }}">Add Version Product</a>
              </li>
              <li> <a href="{{ url('employee/stocks/UpdateQnttToProduct') }}">Update Qnt of Product</a>
              </li>
            </ul>
          </li>
          <!-- stock product end -->
